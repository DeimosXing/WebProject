...
@Controller
public class SSDisplayController {
    ...
    @Autowired
    private SSIAdminService adminService;
...
/*
    ...
    */
    ...
    public String teamManage(HttpServletRequest req){
//        if(req.getSession().getAttribute("id")==null){
//            return "adminLogin";
//        }
        List<SSTeam> teams=adminService.getAllTeams();
